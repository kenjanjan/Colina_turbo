...
import { addVaccinationFile, getCurrentFileCountFromDatabase } from "@/app/api/vaccinations-api/vaccinations.api";
...
export const NofileviewVaccinationsModalContent = ({
  vaccinationUuid,
  isModalOpen,
  ...
  useEffect(() => {
    ...
    if (vaccinationFiles && vaccinationFiles.length > 0) {
      // Push file names to selectedFileNames array
      for (let file of vaccinationFiles) {
  ...
  }, [vaccinationFiles, defaultVaccinationFiles]);
    ...
    return (
      ...
      >
        <div className="justify-center flex">
          <div
            className={`flex  pt-14 flex-row justify-items-center ${defaultVaccinationFiles.length === 5
              ? "cursor-not-allowed"
              : "cursor-pointer"
              }`}
          >
            ...
            <label
              htmlFor="fileupload"
              className={` ${defaultVaccinationFiles.length === 5
                ? "cursor-not-allowed"
                : "cursor-pointer"
...
export default NofileviewVaccinationsModalContent;
