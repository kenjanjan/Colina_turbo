...
export async function fetchPatientProfileImage(
  patientUuid: string,
  router: any,
) {
  try {
...
export async function fetchProfileImages(patientUuids: string[]) {
  try {
    ...
    const response = await axios.post(
      `${apiUrl}/patient-information/profile-images`,
      {
        patientUuids,
      },
      { headers },
...
export async function addPatientProfileImage(
  patientUuid: string,
  formData: any,
) {
  try {
    ...
    await axios.post(
      `${apiUrl}/patient-information/${patientUuid}/upload-profile-image`,
      formData,
      {
        headers,
      },
...
export async function updatePatientProfileImage(
  ...
  try {
    ...
    await axios.patch(
      `${apiUrl}/patient-information/${patientUuid}/update-profile-image`,
      formData,
      {
        headers,
      },
