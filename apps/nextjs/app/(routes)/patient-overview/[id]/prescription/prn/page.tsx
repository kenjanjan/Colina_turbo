...
import { formatCreatedAtDate, formatDate } from "@/lib/utils";
              ...
              <table className="text-left rtl:text-right">
                <thead>
                  <tr className="h-[70px] border-b text-[15px] font-semibold uppercase text-[#64748B]">
                    ...
                    <td className="w-[160px] py-3">START DATE</td>
                    <td className="w-[160px] py-3">END DATE</td>
                          ...
                          <td className="w-[160px] py-3">
                            <ResuableTooltip
                              text={formatCreatedAtDate(
                                prescription.prescriptions_startDate,
                              )}
                            />
                          </td>
                          <td className="w-[160px] py-3">
                            <ResuableTooltip
                              text={formatCreatedAtDate(
                                prescription.prescriptions_endDate,
                              )}
                            />
                          </td>
                          <td className="w-[160px] py-3">
